...
public final class TyreSkMmg {
     ...
     */
    public static int WIN_WIDTH = 260;

    /**
     * The target window height.
     */
    public static int WIN_HEIGHT = 210;

    /**
     * The game panel width.
     */
    public static int PANEL_WIDTH = 240;

    /**
     * The game panel height.
     */
    public static int PANEL_HEIGHT = 136;
     ...
     * The game height.
     */
    public static int GAME_HEIGHT = 136;    
     ...
     */
    public static String ENGINE_CONFIG_FILE = "../cfg/engine_config_tyre_sk.xml";
    ...
    public static void RunOsSpecificCode() {
        try {
            ...
            if (isWindows(OS)) {
                ...
                GameSettings.GAMEPAD_2_ON = false;
                GameSettings.GPIO_GAMEPAD_ON = false;
                GameSettings.GPIO_GAMEPAD_THREADED_POLLING = false;
    ...
    public static final void main(String[] args) {
        ...
        try {
            if (TyreSkMmg.ENGINE_CONFIG_FILE != null && TyreSkMmg.ENGINE_CONFIG_FILE.equals("") == false) {
                GameSettingsImporter dci = new GameSettingsImporter();
                boolean r = dci.ImportGameSettings(TyreSkMmg.ENGINE_CONFIG_FILE);
                    ...
                    for (int i = 0; i < len; i++) {
                        try {
                            ...
                            if (ent.from != null && ent.from.equals("GameSettings") == true) {
                                ...
                                f = TyreSkMmg.class.getField(ent.key);
                                if (f != null) {
                                    System.out.println("Importing " + ent.from + " field: " + ent.key + " with value: " + ent.val + " with type: " + ent.type + " from: " + ent.from);
                                    SetField(ent, f);
                                }             
        ...
        Logger.wr("Window Width: " + WIN_WIDTH);
        Logger.wr("Window Height: " + WIN_HEIGHT);
        Logger.wr("Panel Width: " + PANEL_WIDTH);
        Logger.wr("Panel Height: " + PANEL_HEIGHT);
        Logger.wr("Game Width: " + GAME_WIDTH);
        Logger.wr("Game Height: " + GAME_HEIGHT);

        mf = new MainFrame(TyreSkMmg.WIN_WIDTH, TyreSkMmg.WIN_HEIGHT, TyreSkMmg.PANEL_WIDTH, TyreSkMmg.PANEL_HEIGHT, TyreSkMmg.GAME_WIDTH, TyreSkMmg.GAME_HEIGHT);
        pnlGame = new GamePanel(mf, TyreSkMmg.PANEL_WIDTH, TyreSkMmg.PANEL_HEIGHT, 2, 19, TyreSkMmg.GAME_WIDTH, TyreSkMmg.GAME_HEIGHT);
        mf.SetGamePanel(pnlGame);
        mf.InitComponents();
        fr = new RunFrameRate(mf, FPS);

        mf.setSize(TyreSkMmg.WIN_WIDTH, TyreSkMmg.WIN_HEIGHT);
        ...
        Logger.wr("GamePanel MyX: " + pnlGame.myX);
        Logger.wr("GamePanel MyY: " + pnlGame.myY);        
    }
}
