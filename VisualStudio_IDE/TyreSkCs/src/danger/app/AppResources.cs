...
namespace danger.app {
     ...
     */
    public class AppResources : Resources {
        ...
        public static string ID_APP_FONT_LIGHT_str = "Dongle-Light.ttf";
        public static int ID_APP_FONT_REGULAR = 510;
        public static string ID_APP_FONT_REGULAR_str = "Dongle-Regular.ttf";
        public static int ID_APP_FONT_BOLD = 509;
        public static string ID_APP_FONT_BOLD_str = "Dongle-Bold.ttf";
        ...
        public static string FONT_GROUP_str = "12";
