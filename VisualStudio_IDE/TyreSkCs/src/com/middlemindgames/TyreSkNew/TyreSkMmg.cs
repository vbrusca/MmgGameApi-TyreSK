...
namespace com.middlemindgames.TyreSkNew
{
    ...
    public static class TyreSkMmg
    {
        ...
        /// </summary>
        public static int PANEL_HEIGHT = 136; //416;
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                com.middlemindgames.TyreSkNew.GamePanel.pW = PANEL_WIDTH;
                com.middlemindgames.TyreSkNew.GamePanel.pH = PANEL_HEIGHT;
                com.middlemindgames.TyreSkNew.GamePanel.wW = WIN_WIDTH;
                com.middlemindgames.TyreSkNew.GamePanel.wH = WIN_HEIGHT;
