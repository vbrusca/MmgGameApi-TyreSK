...
namespace com.middlemindgames.TyreSkOrig {
     ...
     */
    public class collisionBot : Constants {
        ...
        public bool torchMessage;
        public bool linktColl;
        ...
        public bool collision(int x, int y, int width, int height, int pX, int pY, int diff, int posX, int posY) {
        ...
        private bool tileCollisionCalculation() {
        ...
        public bool tileCollision(int x, int y, int width, int height, int pX, int pY, int posX, int posY) {
            targetUpperLimit = y;
            targetLowerLimit = (y + height);
            targetLeftLimit = x;
            targetRightLimit = (x + width);
        ...
        private bool collisionCalculation(int posX, int posY) {
            //determine if there is any overlapping
                            ...
                            for (i = 0; i < Tyre.linkObjects.Length; i++) {
                                try {
                                    if (Tyre.linkObjects[i].flagIndex == -1
                                        ...
                                        if (cw) {
                                            linktColl = true;
                                            if (ResourceContainer.rooms[ResourceContainer.linkTables[Tyre.linkObjects[i].linkTo].roomIndex].roomType == ROOMTYPE_TUNNEL) {
                                                int inventoryIndex = Tyre.player.inInventory(ITEM_TORCH);
                                                if (inventoryIndex > -1) {
